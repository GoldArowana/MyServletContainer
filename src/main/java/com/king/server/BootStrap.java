...
import com.king.server.demo.EchoEventHandler;
import com.king.server.demo.FileEventHandler;
import com.king.server.demo.NIOEchoEventHandler;
import com.king.server.event.listener.EventListener;
import com.king.server.io.connection.Connection;
import com.king.server.io.connector.impl.nio.SocketChannelConnector;
...
import com.king.server.io.event.listener.impl.SelectableChannleEventListener;
...
public class BootStrap {
    public static void main(String[] args) throws IOException {
        ...
        SocketConnector connector =
                SocketConnectorFactory.build(18080, socketEventListener);

        EventListener<Connection> socketEventListener2 =
                new ConnectionEventListener(
                        new FileEventHandler(System.getProperty("user.dir")));
        ...
        EventListener<SelectionKey> nioEventListener =
                new SelectableChannleEventListener(new NIOEchoEventHandler());

        SocketChannelConnector socketChannelConnector =
                new SocketChannelConnector(18082, nioEventListener);
